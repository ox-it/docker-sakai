...
fig is used to mount the files inside the container when in production, but there is another container that actually copies them in for proper production.
